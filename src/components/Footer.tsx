    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            <Link to="/" className="flex items-center">
              ...
              <span className="text-xl font-bold text-white">FundRise</span>
            </Link>
            <p className="mt-2 text-sm">
              Empowering creators and changemakers through community funding.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex">
              <input
                ...
                className="w-full px-3 py-2 text-sm text-gray-900 bg-gray-100 rounded-l outline-none"
              />
              <button className="bg-gradient-to-r from-teal-500 to-indigo-600 text-white px-4 py-2 rounded-r text-sm font-medium">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-6 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm">© 2025 FundRise. All rights reserved.</p>
